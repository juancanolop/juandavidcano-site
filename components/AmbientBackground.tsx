...
export default function AmbientBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      <div
        className="absolute left-1/2 top-[-120px] h-[750px] w-[1150px] -translate-x-1/2 rounded-full opacity-60 blur-[90px]"
        style={{ background: "radial-gradient(circle, rgb(125,203,255) 0%, rgba(125,203,255,0.6) 40%, transparent 72%)" }}
      />
      <div
        className="absolute left-1/2 top-[80px] h-[600px] w-[950px] -translate-x-1/2 rounded-full opacity-50 blur-[100px]"
        style={{ background: "radial-gradient(circle, rgb(139,92,246) 0%, rgba(139,92,246,0.55) 40%, transparent 72%)" }}
      />
    </div>
  );
}
